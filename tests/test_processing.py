...
def test_filter_by_state_default(sample_data: list[dict]) -> None:
...
def test_filter_by_state_empty(sample_data: list[dict]) -> None:
...
def test_sort_by_date_same_date(sample_data: list[dict]) -> None:
